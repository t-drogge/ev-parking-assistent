...
class EchoBot extends ActivityHandler {
    constructor(configuration, qnaOptions) {
        ...
        //if (!configuration) throw new Error("[QnAMakerBot]: Missing configuration pararamter");
        //this.qnaMaker = new QnAMaker(configuration.QnAConfiguration, qnaOptions);
        
        // create a LUIS connector
        //this.intentRecognizer = new IntentRecognizer(configuration.LuisConfiguration);

        const key = '7589e809ae8d4392bed182ec0dd736d0';
        const endpoint = 'https://ev-parking-assistant-language.cognitiveservices.azure.com/';
